...
final class TerminalRefreshAudit {
    ...
    private static CompoundTag state(){var tag=net.minecraft.world.level.storage.TagValueOutput.createWithContext(net.minecraft.util.ProblemReporter.DISCARDING,level.registryAccess());host.saveAdditional(tag);return tag.buildResult();}
    private static void load(CompoundTag tag){host.loadTag(net.minecraft.world.level.storage.TagValueInput.create(net.minecraft.util.ProblemReporter.DISCARDING,level.registryAccess(),tag));}
