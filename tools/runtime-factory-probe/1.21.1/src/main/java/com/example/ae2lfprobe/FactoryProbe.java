...
public final class FactoryProbe {
    ...
    public FactoryProbe(net.neoforged.bus.api.IEventBus modEventBus) {
        NeoForge.EVENT_BUS.addListener(this::tick);
        modEventBus.addListener(SoulCompatAudit::registerCapability);
    }
    ...
    private void tick(ServerTickEvent.Post event) {
        ...
        StressAudit.tick(); TopologyAudit.tick(); TerminalAudit.tick(); InductionAudit.tick(); MultiTagAudit.tick(); ComplexFlowAudit.tick(); MekanismBulkAudit.tick(); NativeCapabilityAudit.tick(); SoulCompatAudit.tick(); RecipeSetAudit.tick();
